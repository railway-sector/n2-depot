import{kG as Pe,m$ as be,q0 as we,E$ as f,pR as w,pX as Ve,pK as F,IG as r,FU as U,GH as Y,BN as De,pO as C,oK as ee,j4 as R,jM as H,q1 as xe,Cd as te,F6 as ie,pM as M,bs as m,AQ as v,Nq as ne,A1 as se,yT as o,B3 as ae,hK as Ee,vl as ye,fw as Le,lQ as re,z9 as le,KW as Se,IO as Ce,u5 as Me,IM as Ae,pS as $e,Af as B,oN as Re,rW as oe,IH as ce,jw as he,mh as Te,E6 as G,KX as q,jt as c,lH as z,HO as de,fZ as pe,oB as Oe,Js as O,ja as Ie,F2 as qe,Ee as je,kI as Ue,us as D,kH as ze,rZ as k,Fb as Ne,Ei as We,D7 as T,BP as Fe,xV as He,L8 as Be,f7 as Ge,Cg as ke,l5 as Ke,tt as Xe,jy as A,lv as Qe,I3 as K}from"./index-CgIaXlqt.js";import{t as Ze}from"./VisualElement-BW7wwq3o.js";function ue(t,e){const n=t.fragment;n.include(Pe),t.include(be),n.include(we),n.uniforms.add(new f("globalAlpha",i=>i.globalAlpha),new w("glowColor",i=>i.glowColor),new f("glowWidth",(i,s)=>i.glowWidth*s.camera.pixelRatio),new f("glowFalloff",i=>i.glowFalloff),new w("innerColor",i=>i.innerColor),new f("innerWidth",(i,s)=>i.innerWidth*s.camera.pixelRatio),new Ve("depthMap",i=>i.depth?.attachment),new F("normalMap",i=>i.normals)),n.code.add(r`vec4 premultipliedColor(vec3 rgb, float alpha) {
...
return abs(dist);
}`),t.spherical){const i=(a,l,p)=>m(a,l.heightManifoldTarget,p.camera.viewMatrix),s=(a,l)=>m(a,[0,0,0],l.camera.viewMatrix);n.uniforms.add(new C("heightManifoldOrigin",(a,l)=>(i(u,a,l),s(V,l),ee(V,V,u),R(d,V),d[3]=H(V),d)),new xe("globalOrigin",a=>s(u,a)),new f("cosSphericalAngleThreshold",(a,l)=>1-Math.max(2,te(l.camera.eye,a.heightManifoldTarget)*l.camera.perRenderPixelRatio)/H(a.heightManifoldTarget))),n.code.add(r`float globeDistancePixels(float posInGlobalOriginLength) {
...
vec4 color = vec4(0.0);`),t.heightManifoldEnabled){n.uniforms.add(new M("angleCutoff",s=>$(s)),new C("heightPlane",(s,a)=>ge(s.heightManifoldTarget,s.renderCoordsHelper.worldUpAtPosition(s.heightManifoldTarget,u),a.camera.viewMatrix)));const i=t.spherical?r`normalize(globalOrigin - pos)`:r`heightPlane.xyz`;n.main.add(r`
      ...
      color = max(color, heightManifoldColor * heightManifoldAlpha);`)}return t.pointDistanceEnabled&&(n.uniforms.add(new M("angleCutoff",i=>$(i)),new C("pointDistanceSphere",(i,s)=>Je(i,s))),n.main.add(r`float pointDistanceSphereDistance = sphereDistancePixels(pointDistanceSphere, pos);
