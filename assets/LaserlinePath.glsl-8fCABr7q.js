import{l5 as be,nv as we,qK as De,FM as f,qB as w,qH as Ve,qr as W,Jv as r,tj as q,Hr as ee,CQ as xe,qy as y,mk as te,jt as A,ka as F,qL as Le,De as ie,FS as ne,qw as S,h4 as _,BO as v,Ow as se,B3 as ae,zT as o,KE as re,i1 as Ee,H as ye,fU as Se,pk as le,A6 as oe,LR as Ce,JB as Me,vd as Ae,Jy as $e,qC as Re,Bl as H,pu as Te,oo as ce,IV as he,jU as de,mt as Oe,ES as G,LZ as j,jR as c,ma as z,Iy as pe,gk as ue,pj as Ie,Kh as I,jz as Ue,FP as je,EZ as qe,l6 as ze,vz as V,KK as Ne,hC as k,HQ as Be,F1 as We,E2 as $,CS as Fe,bi as K,z7 as He,M5 as Ge,fC as ke,Dx as Ke,lJ as Ze,uZ as Je,jZ as C,lX as Qe,IL as Z}from"./index-DYd-m-VK.js";import{t as Xe}from"./VisualElement-D7eAz-or.js";function fe(t,e){const n=t.fragment;n.include(be),t.include(we),n.include(De),n.uniforms.add(new f("globalAlpha",i=>i.globalAlpha),new w("glowColor",i=>i.glowColor),new f("glowWidth",(i,s)=>i.glowWidth*s.camera.pixelRatio),new f("glowFalloff",i=>i.glowFalloff),new w("innerColor",i=>i.innerColor),new f("innerWidth",(i,s)=>i.innerWidth*s.camera.pixelRatio),new Ve("depthMap",i=>i.depth?.attachment),new W("normalMap",i=>i.normals)),n.code.add(r`vec4 premultipliedColor(vec3 rgb, float alpha) {
...
return abs(dist);
}`),t.spherical){const i=(a,l,p)=>_(a,l.heightManifoldTarget,p.camera.viewMatrix),s=(a,l)=>_(a,[0,0,0],l.camera.viewMatrix);n.uniforms.add(new y("heightManifoldOrigin",(a,l)=>(i(u,a,l),s(D,l),te(D,D,u),A(d,D),d[3]=F(D),d)),new Le("globalOrigin",a=>s(u,a)),new f("cosSphericalAngleThreshold",(a,l)=>1-Math.max(2,ie(l.camera.eye,a.heightManifoldTarget)*l.camera.perRenderPixelRatio)/F(a.heightManifoldTarget))),n.code.add(r`float globeDistancePixels(float posInGlobalOriginLength) {
