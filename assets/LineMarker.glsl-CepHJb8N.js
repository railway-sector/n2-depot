import{GH as ee,re as te,uu as ie,uq as re,ra as ae,pS as se,pT as oe,IG as o,D4 as ne,IM as ce,F6 as le,Af as _,LV as pe,pU as de,H2 as I,sY as he,pI as ve,pJ as ue,pO as me,pK as fe,uv as E,og as R,Aj as ge,kD as Se,oc as Pe,fZ as ye,rW as we,HO as _e,IH as ze,jw as xe,LS as L,II as U,mW as $e,rb as B,Kx as M,rd as be,sZ as Te,xp as ke,BJ as Ve,BK as k,rc as Oe,pV as De,Ak as H,kE as q,KA as We,uw as Ce,kF as Le,jt as c,lH as Me,F0 as Ae,us as d,jK as Fe,kz as je,Ms as K,Bh as Ne,F4 as Ie,IN as Ee,IJ as Re,Js as J,bS as Ue,bs as G,yT as Y,Mt as Be}from"./index-CgIaXlqt.js";function Z(t){const e=new ee,{space:r,anchor:i,hasTip:P,hasScreenSizePerspective:z}=t,u=r===2,g=r===1;e.include(te,t),e.include(ie,t),e.include(re,t);const{vertex:a,fragment:S,varyings:y}=e;ae(a,t),e.attributes.add("position","vec3"),e.attributes.add("previousDelta","vec4"),e.attributes.add("uv0","vec2"),y.add("vColor","vec4"),y.add("vpos","vec3",{invariant:!0}),y.add("vUV","vec2"),y.add("vSize","float"),P&&y.add("vLineWidth","float"),a.uniforms.add(new se("nearFar",({camera:p})=>p.nearFar),new oe("viewport",({camera:p})=>p.fullViewport)).code.add(o`vec4 projectAndScale(vec4 pos) {
